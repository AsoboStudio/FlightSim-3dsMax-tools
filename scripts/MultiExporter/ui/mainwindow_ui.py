...
class Ui_MultiExporter(object):
    def setupUi(self, MultiExporter):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 659, 442))
        ...
        self.horizontalLayout_8.addWidget(self.btnEditPresetPath)
    ...
    def retranslateUi(self, MultiExporter):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), QtWidgets.QApplication.translate("MultiExporter", "Environment", None, -1))
        self.treePresets.headerItem().setText(0, QtWidgets.QApplication.translate("MultiExporter", "         Preset", None, -1))
        self.treePresets.headerItem().setText(1, QtWidgets.QApplication.translate("MultiExporter", "Path", None, -1))
        __sortingEnabled = self.treePresets.isSortingEnabled()
        self.treePresets.setSortingEnabled(False)
        self.treePresets.topLevelItem(0).setText(0, QtWidgets.QApplication.translate("MultiExporter", "loul", None, -1))
        self.treePresets.topLevelItem(0).setText(1, QtWidgets.QApplication.translate("MultiExporter", "Domegaloul/omegaloul/omegaloul/omegaloul/omegaloul/omegaloul/omegaloul/omegaloul/omegaloul/omegaloul/omegaloul/omegaloul/omegaloul/omegaloul/omegaloul/omegaloul/omegaloul/omegaloul/omegaloul/omegaloul/", None, -1))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabPreset), QtWidgets.QApplication.translate("MultiExporter", "Planes", None, -1))
